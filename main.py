...
@app.get("/personal-care-notes/", response_model=List[schemas.DailyNotePersonalCareRedacted])
...
@app.get("/medication-notes/", response_model=List[schemas.DailyNoteMedicationRedacted])
...
@app.get("/accidents-incidents/", response_model=List[schemas.DailyNoteAccidentsIncidentsRedacted])
...
@app.get("/general-notes/", response_model=List[schemas.DailyNoteGeneralNoteRedacted])
...
@app.get("/leisure-activity-notes/", response_model=List[schemas.DailyNoteLeisureActivityRedacted])
...
@app.get("/contact-logs/", response_model=List[schemas.DailyNoteContactLogRedacted])
...
@app.get("/medication-administrations/", response_model=List[schemas.DailyNoteMedicationAdministrationRedacted])
...
@app.get("/night-checks/", response_model=List[schemas.DailyNoteNightCheckRedacted])
...
@app.get("/moods/", response_model=List[schemas.DailyNoteMood])
...
@app.get("/health-monitoring-notes/", response_model=List[schemas.DailyNoteHealthMonitoringRedacted])
...
@app.get("/meals/", response_model=List[schemas.DailyNoteMealRedacted])
...
@app.get("/service-users/", response_model=List[schemas.ServiceUserRedacted])
